...
jsx = jsx.replace(
    ...
    '  const [usersReady,   setUsersReady]   = useState(()=>{ try{const u=JSON.parse(localStorage.getItem("buff_appUsers")); return !!(u&&u.length>0);}catch{return false;} });\n'
    ...
    '  useEffect(()=>{\n'
    '    const t = setTimeout(()=>setUsersReady(true), 5000);\n'
    '    fetch(SCRIPT_URL)\n'
    '      .then(r=>r.json())\n'
    '      .then(data=>{\n'
